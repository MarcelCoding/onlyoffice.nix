...
let
  ...
  onlyoffice-documentserver = stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-grLln/fTBkotNWFL52ab7IhzXwg32seGdi97pqWVz/M=";
    };
    ...
    installPhase = ''
      ...
      rm -f var/www/onlyoffice/documentserver/server/FileConverter/bin/x2t
      rm -f var/www/onlyoffice/documentserver/server/tools/allfontsgen
      rm -f var/www/onlyoffice/documentserver/server/tools/allthemesgen

      ln -s ${x2t}/bin/x2t var/www/onlyoffice/documentserver/server/FileConverter/bin/x2t
      ...
      fhs = buildFHSEnv {
        ...
        runScript = writeScript "onlyoffice-documentserver-run-script" ''
          ...
          if [[ $1 == DocService/docservice ]]; then
            ...
            ${lib.getExe strace} ${allfontsgen}/bin/allfontsgen \
            ...
            ${lib.getExe strace} ${allthemesgen}/bin/allthemesgen \
